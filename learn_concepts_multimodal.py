...
def config():
    ...
    parser.add_argument("--classes", default="awa2", type=str)
...
if __name__ == "__main__":
    ...
    if args.classes == "awa2":
        ...
        all_classes=pd.read_csv('/media/steven/WDD/research/data/Concept_ZSL/Animals_with_Attributes2/Animals_with_Attributes2/trainclasses.txt',header=None)[0].to_list()
