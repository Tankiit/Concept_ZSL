...
class GZSLDeiT3(L.LightningModule):
    def __init__(self, NUM_CLASSES, NUM_FEATURES, EPOCHS, NUM_EXCLUDE, training_loader, validation_loader):
        super().__init__()
    ...
    def configure_optimizers(self):
        return torch.optim.Adam(self.parameters(), lr=3e-5, weight_decay=1e-5)
